...
approximately 06:30 GMT, an outage occurred on an isolated
...
Bug debugger sapencio encountered the issue upon opening the project and being, well, instructed to
address it, roughly 9:20 GMT. He promptly proceeded to undergo solving the problem.
...
[0-strace_is_your_friend.pp](https://github.com/sapencio/alx-system_engineering-devops/blob/master/0x17-web_stack_debugging_3/0-strace_is_your_friend.pp)
